...
def load_data(filepath):
    with open(filepath, encoding='utf-8') as json_file:
        ...
        all_name = []
        all_bars_list = []
        while count < lenjson:  # создаем списки
            bar_seats_count = json_data['features'][count]['properties']['Attributes']['SeatsCount']
            bar_address = json_data['features'][count]['properties']['Attributes']['Address']
            bar_name = json_data['features'][count]['properties']['Attributes']['Name']
            lat_long = json_data['features'][count]['geometry']['coordinates']
